<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Cadastro.aspx.cs" Inherits="WebApplication2.Cadastro" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Conteudo" runat="server">
    <div class="margin-top-60">
        ...
        <asp:TextBox ID="NomeAcesso" MaxLength="256" runat="server"></asp:TextBox>
